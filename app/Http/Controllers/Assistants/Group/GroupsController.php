...
namespace App\Http\Controllers\Assistants\Group;
...
//        dd("here is the place we met before");
        ...
        return view("interface.assistants.vikundi.orodhaMakundi")
        ->with("groups", $groups)
            ->with('side', $side);
    }
    ...
    public function showSingleGroup(Group $group, Request $request){
        ...
        return view('interface.assistants.vikundi.wajumbe_mkutano_mkuu_wilaya')
