...
namespace App\Http\Controllers\Assistants\Apartment;
...
class ApartmentsController extends Controller
{
    ...
    public function  show($id)
    {
        ...
        return view('interface.assistants.apartments.showApartment')
    ...
    public function unpaid(){
       $unPaidApartments = $this->queryUnpaid();
        return \view('interface.assistants.apartments.allUnpaidApartments')
