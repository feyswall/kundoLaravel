    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="houses-table" class="table table-striped table-bordered dt-responsive nowrap display"
                            ...
                            @foreach( $houses as $house )
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('assistants.houses.showHouse', $house->id) }}"
        ...
        <!-- end row -->
            <x-system.modal id="createNewHouse" aria="houseRegistration" size="modal-lg" title="Sajiri Nyumba Mpya">
                <x-slot:content>
                    <form method="POST" action="{{ route('assistants.houses.storeHouse') }}">
                        @csrf
                        <div>
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-8 col-sm-12">
                                    ...
                                    <p>Hukupa Aina ya hii nyumba?
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#createNewHouseType"
                                           class="mb-4"> <b>Bonyeza Hapa</b> </a>
            ...
            <x-slot:content>
                <form method="POST" action="{{ route('assistants.houseTypes.storeHouseType') }}">
                    @csrf
                    <div>
                        <div class="row justify-content-center">
                            <div class="col-lg-8 col-sm-12">
