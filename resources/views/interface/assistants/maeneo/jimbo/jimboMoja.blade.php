                    ...
                    <div style="border-top: #9393; border-top-style: dashed; border-width: 2px;" class="py-3">
                        <div class="d-flex justify-content-md-between justify-content-center items-center flex-wrap-reverse mb-3">
                            ...
                            <div class="d-flex items-center justify-content-center gap-2">
                                ...
                                <a href="{{ route("assistants.areas.jimbo.orodha", $state->district->id) }}" class="btn btn-primary btn-md mb-4">Rudi Kwenye Wilaya</a>
                            </div>
                        </div>
                        <div>
                            <div class="d-flex justify-start gap-4 flex-wrap">
                                ...
                                <div class="text-center">
                                    <a class="fas fa-edit" data-bs-toggle="tooltip"
                                ...
                                <x-system.assistant.modal id="futaTaarifaKiongoziChamaModal_{{ $leader->id }}" aria="futaKiongoziKataLabel"
                                    ...
                                    <x-slot:content>
                                        <form action="{{ route('assistants.leader.unpower')}}" method="POST">
                                            ...
                                            <input type="hidden" name="column_id" value="state_id">
                                            <input type="hidden" name="column_value" value="{{ $state->id }}">
                        ...
                        <!-- model location here -->
                        <x-system.assistant.modal id="ongezaKiongoziModal" aria="orodhaTawiLabel" size="modal-fullscreen" title="Ongeza Tawi Hapa">
                            <x-slot:content>
                                <form method="post" action="{{ route('assistants.leader.jimbo.ongeza') }}">
                                    @csrf
