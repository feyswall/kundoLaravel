                            ...
                            <div>
                                <div class="px-md-3">
                                    ...
                                    <div style="border-top: #9393; border-top-style: dashed; border-width: 2px;" class="py-3">
                                                ...
                                                @foreach($leaderColl as $id => $ldr)
                                                    <div class="text-start">
                                                        <a class="fas fa-edit" data-bs-toggle="tooltip" data-bs-placement="top"
                                                         title="Badilisha" href="{{ route("assistants.leader.tarafa.badili", $ldr->id ) }}"></a>
                                        ...
                                        <!-- model location here -->
                                        <x-system.assistant.modal id="ongezaKiongoziChamaModal" aria="ongezaKiongoziTarafaLabel" size="modal-fullscreen" title="Ongeza Kiongozi Tarafa Hapa">
                                            <x-slot:content>
                                                ...
                                                <form method="post"
                                                    action="{{ route('assistants.leader.halmashauri.ongeza') }}"
                            ...
                            <div>
                                <div class="px-md-3">
                                    <div style="border-top: #9393; border-top-style: dashed; border-width: 2px;" class="py-3">
                                                    ...
                                                    @php $ps = \App\Models\Post::find($key); @endphp
                                                        @foreach($leaderColl as $id => $ldr)
                                                            <div class="text-start">
                                                                <a class="fas fa-edit" data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Badilisha"
                                                                    href="{{ route("assistants.leader.tarafa.badili", $ldr->id ) }}">
                                                                </a>
                                                                <a class="fas fa-trash text-danger"  data-bs-toggle="modal"
                                        ...
                                        <!-- model location here -->
                                        <x-system.assistant.modal id="ongezaKiongoziSerikaliModal"
...
<x-system.assistant.collapse id="kamatiZaHalmashauri" title="kamati Ngazi ya Halmashauri">
    <x-slot:content>
        ...
        <x-system.assistant.collapse :id="$group->deep" :title="strtoupper($group->name)">
            <x-slot:content>
                <x-system.assistant.groups-info :group="$group" :table="$council" />
            </x-slot:content>
...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('assistants.areas.halmashauri.orodha', $council->district->id) }}" class="btn btn-primary btn-sm mb-4">Rudi Wilayani</a>
                    <x-system.assistant.tarafa-table :areas="$areas">
                    </x-system.assistant.tarafa-table>
                </div>
            </div>
        </div> <!-- end col -->
    </div> <!-- end row -->
    ...
    <!-- model location here -->
    <x-system.assistant.modal id="orodhaTarafaModal" aria="orodhaTarafaLabel" size="modal-lg" title="Ongeza Tarafa Hapa">
        <x-slot:content>
            <form method="post" action="{{ route('assistants.areas.tarafa.ongeza') }}">
                @csrf
                <div>
                    <div class="row">
                        <div class="col-lg-12">
...
@section("extra_script")
    <x-system.assistant.table-script id="assistantsOrodhaTafaraTable"></x-system.assistant.table-script>
    <script>
        let app =  new Vue({
            el: '#app',
            data() {
