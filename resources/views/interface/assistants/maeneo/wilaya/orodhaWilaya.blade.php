...
@section("content")
    ...
    <!-- ============================================================== -->
                                                ...
                                                <x-system.assistant.modal id="badiriTaarifaKiongoziChamaModal_{{ $ldr->id }}"
                                                    ...
                                                    <x-slot:content>
                                                        <x-system.assistant.edit-leader :leader="$ldr"
                                                                              :route="route('assistants.leader.mkoa.sasisha', $ldr->id )" />
                                                    </x-slot:content>
                                                </x-system.assistant.modal>
                                            @endforeach
                                        @endforeach
                                        <!-- model location here -->
                                        <x-system.assistant.modal id="ongezaKiongoziChamaModal" aria="ongezaKiongoziMkoaLabel" size="modal-fullscreen" title="Ongeza Kiongozi Wa Chama Mkoa Hapa" >
                                            <x-slot:content>
                                                <form method="post" action="{{ route('assistants.leader.mkoa.ongeza') }}">
                                                    @csrf
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="p-2">
                                        ...
                                        @endforeach
                                            <!-- model location here -->
                                            <x-system.assistant.modal id="ongezaKiongoziSerikaliModal" aria="ongezaKiongoziMkoaLabel" size="modal-fullscreen" title="Ongeza Kiongozi Wa Serikali Mkoa Hapa" >
                                                <x-slot:content>
                                                    <form method="post" action="{{ route('assistants.leader.mkoa.ongeza') }}">
                                                        @csrf
            ...
            <x-system.assistant.collapse id="kamatiZaChamaMkoa" title="kamati Za  Chama Mkoa">
                <x-slot:content>
                    @foreach( \App\Models\Group::with("posts")->where("basedOn", "mkoa")->where('side', 'chama')->get() as $group)
                            <x-system.assistant.collapse :id="$group->deep" :title="strtoupper($group->name)">
                                <x-slot:content>
                                    <x-system.assistant.groups-info :group="$group" :table="$region"/>
                                </x-slot:content>
            ...
            <x-system.assistant.collapse id="kamatiZaSerikaliMkoa" title="kamati Za  Serikali Mkoa">
                <x-slot:content>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <x-system.assistant.wilaya-table :areas="$areas">
                                </x-system.assistant.wilaya-table>
                            </div>
                        </div>
                    </div> <!-- end col -->
                </div> <!-- end row -->
                ...
                <!-- model location here -->
                <x-system.assistant.modal id="exampleModal" aria="orodhaWilayaLabel" size="modal-lg" title="Ongeza Wilaya Hapa" >
                    <x-slot:content>
                        <x-system.assistant.ongeza-wilaya-modal-form />
                    </x-slot:content>
                </x-system.assistant.modal>
    ...
    @section("extra_script")
        <x-system.assistant.table-script id="assistantsOrodhaWilayaTable">
