                                        ...
                                        <div>
                                            <div class="d-flex justify-start gap-4 flex-wrap">
                                                @php
                                                    ...
                                                    $chamaPostsWithLeaderCollection = \App\Http\Controllers\Assistants\PostsController::postWithLeaders($wardLeaders, 'chama', 'kata');
                                                @endphp
                                                ...
                                                <x-system.assistant.modal id="badiriTaarifaKiongoziChamaModal_{{ $ldr->id }}"
                                                    ...
                                                    <x-slot:content>
                                                        <x-system.assistant.edit-leader :leader="$ldr"
                                                         :route="route('assistants.leader.kata.sasisha', $ldr->id)" />
                                                    </x-slot:content>
                                                </x-system.assistant.modal>
                                            @endforeach
                                        @endforeach
                                        <!-- model location here -->
                                        <x-system.assistant.modal id="ongezaKiongoziChamaModal" aria="ongezaKiongoziKataLabel"
                                            ...
                                            <x-slot:content>
                                                ...
                                                action="{{ route('assistants.leader.kata.ongeza') }}">
                                                    @csrf
                                ...
                                <div>
                                    <div style="border-top: #9393; border-top-style: dashed; border-width: 2px;" class="py-3">
                                        ...
                                        <div>
                                            <div class="d-flex justify-start gap-4 flex-wrap">
                                                @php
                                                    ...
                                                    $serikaliPostsWithLeaderCollection = \App\Http\Controllers\Assistants\PostsController::postWithLeaders($serWardLeaders, 'serikali', 'kata');
                                                @endphp
                                        ...
                                        @foreach ($serikaliPostsWithLeaderCollection as $leaderColl)
                                                @foreach( $leaderColl as $ldr )
                                                <x-system.assistant.modal id="badiriTaarifaKiongoziSerikaliModal_{{ $ldr->id }}" aria="ongezaKiongoziKataLabel" size="modal-fullscreen" title="Ongeza Kiongozi Wa Serikali Kata Hapa">
                                                    <x-slot:content>
                                                        <x-system.assistant.edit-leader :leader="$ldr" :route="route('assistants.leader.kata.sasisha', $ldr->id)" />
                                                    </x-slot:content>
                                                </x-system.assistant.modal>
                                            @endforeach
                                        @endforeach
                                    <!-- model location here -->
                                        <x-system.assistant.modal id="ongezaKiongoziSerikaliModal" aria="ongezaKiongoziKataLabel" size="modal-fullscreen" title="Ongeza Kiongozi Wa Kata Hapa">
                                            <x-slot:content>
                                                <button v-on:click="changeSides()"
...
<x-system.assistant.collapse id="kamatiZaChamaKata" title="kamati Za Chama Ngazi ya Kata">
    <x-slot:content>
        ...
        <x-system.assistant.collapse :id="$group->deep" :title="strtoupper($group->name)">
            <x-slot:content>
                <x-system.assistant.groups-info :group="$group" :table="$ward" />
            </x-slot:content>
...
<x-system.assistant.collapse id="kamatiZaSerikaliKata" title="kamati Za Serikali Ngazi ya Kata">
    <x-slot:content>
...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('assistants.areas.kata.orodha', $ward->division->id) }}" class="btn btn-primary btn-sm mb-4">Rudi Kwenye Tarafa</a>
                    <x-system.assistant.tawi-table :areas="$areas">
                    </x-system.assistant.tawi-table>
                </div>
            </div>
        </div> <!-- end col -->
    </div> <!-- end row -->
    ...
    <!-- model location here -->
    <x-system.assistant.modal id="orodhaTawiModal" aria="orodhaTawiLabel" size="modal-lg" title="Ongeza Tawi Hapa">
        <x-slot:content>
            <form method="post" action="{{ route('assistants.areas.tawi.ongeza') }}">
                @csrf
                <div>
                    <div class="row">
                        <div class="col-lg-12">
...
<x-system.assistant.table-script id="assistantsOrodhaKataTable"></x-system.assistant.table-script>
<script>
    let app =  new Vue({
        el: '#app',
        data() {
