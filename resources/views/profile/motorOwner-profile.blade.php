...
@section('content')
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 " data-bs-toggle="modal" data-bs-target="#badilishaNambaModal">
                                <div class="d-flex justify-content-between align-items-center">
                                    {{--<p class="text-muted mb-0">+{{ $user->leader->phone }}</p>--}}
                                    <a href="#">
                                        <i class="fas fa-edit"></i>
                                        <span>Badilisha Namba Ya Simu</span>
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    {{--<x-system.modal id="badilishaNambaModal" aria="badilishaNywilaModalLabel" size="modal-lg" title="Badilisha Namba Ya Simu">--}}
        {{--<x-slot:content>--}}
            {{--<form method="post" action="{{route('profile.phone', $user->id)}}">--}}
                {{--@method('patch')--}}
                {{--@csrf--}}
                {{--<div class="row">--}}
                    ...
                    {{--<div class="col-12">--}}
                        {{--<div class="mb-3 mb-4">--}}
                            {{--<label class="form-label" for="none">Namba Ya Zamani</label>--}}
                            {{--<input type="text" class="form-control" readonly value="+{{ $user->leader->phone }}" required>--}}
                        {{--</div>--}}
                    {{--</div>--}}

                    {{--<div class="col-sm-12 col-md-12">--}}
                        {{--<div class="mb-3 mb-4">--}}
                            {{--<label class="form-label" for="phone">Namba Mpya</label>--}}
